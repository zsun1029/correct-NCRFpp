                ...
                if yuanwen is not None: 
                    ...
                    if manual_change == True: 
                        ...
                        if wordid < gate:  # 若是易混淆词，则使用易混淆词表修改
                            ...
                            elif change_or_not > 28:  # 使用汉字转拼音来修改 
...
if __name__ == '__main__':
    ...
    save_name = 'officialdoc/haidian_news_sz4'
    vocabid_list_f = 'officialdoc/vocabid_list4.pkl'
    vocab_all = 'officialdoc/vocab_all4.pkl'
    # 构建公文常见混淆词表
 ...
 #  haidian_news()中利用拼音转化出来的word没有加到词表里
    ...
    print( 'vocab_num' ) # 92805 + 25883 = 102674
    print( vocab_num ) # 92805 + 25883 = 102674
